...
public class LibraryDriver {
    public static void main(String[] args) {
        ...
        FileFunctions.createFile ( FILENAME );
        FileFunctions.readFromFile ( FILENAME, bookList );
        if (bookList.isEmpty ()) {
        ...
        FileFunctions.writeToFile ( bookList, FILENAME  );
    }
    ...
    public static void PerfomActionBasedOnInput(int selection, Scanner scan, ArrayList <Book> bookList) {
        ...
        switch (selection) {
            ...
            case 5:
                ...
                break;
            case 6:
                BookListFunctions.RemoveBookFromInventory ( bookList, scan );
                break;
            case 7:
                BookListFunctions.AddBookTotheArray ( bookList, scan );
                break;
            case 8:
                bookList.clear ();
                BookListFunctions.defBookList ( bookList );
